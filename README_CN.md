...
[English](README.md) · [完整实验结果](docs/RESULTS.md) · [简历与面试材料](docs/RESUME.md) · [模型权重](https://huggingface.co/sixteensun/tencentgr-1m-2025-reproduction)
...
| 指标 | 多模态 | no-MM | no-MM 相对变化 |
|---|---:|---:|---:|
| 有效评估用户 | 78,921 | 78,921 | — |
| HR@10 | 0.0313478 | **0.0317533** | +1.29% |
| NDCG@10 | 0.0159694 | **0.0165208** | +3.45% |
| 比赛风格综合分 | 0.0207367 | **0.0212429** | +2.44% |
| 最终验证 BCE | 0.2043 | **0.2040** | — |
| 正式离线评估耗时 | 241.5 秒 | **133.9 秒** | -44.54% |
...
no-MM 使用完全相同的用户、目标与历史长度逐行配对评测。它的点估计更高，但
综合分差值的配对 95% 区间跨过 0，而且两种配置都只训练了一个随机种子。因此
正确结论是“当前融合方式尚未显示稳定收益”，不能据此声称多模态信息普遍无效。
